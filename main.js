...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(folderSerive, db, toastr) {
        this.folderSerive = folderSerive;
        this.db = db;
        this.toastr = toastr;
    }
...
var KmitcComponent = /** @class */ (function () {
    ...
    KmitcComponent.prototype.ngOnInit = function () {
        ...
        this.service.getUsers().subscribe(function (response) {
            ...
            // console.log("Users KMIT Any ",this.kmit);
        });
    };
...
var environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyDF9c8N8JU1hskdJ_uK306u6vOyH4xTs64',
        authDomain: 'mywebapp-71173.firebaseapp.com',
        databaseURL: 'https://mywebapp-71173.firebaseio.com',
        projectId: 'mywebapp-71173',
        storageBucket: 'mywebapp-71173.appspot.com',
        messagingSenderId: '520311862363'
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\Anon\Favorites\Angular\Messenger\src\main.ts */"./src/main.ts");
